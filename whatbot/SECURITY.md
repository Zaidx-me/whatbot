...
whatbot is a self-hosted WhatsApp API gateway. It handles API-key authentication,
...
- **GitHub Security Advisories** (preferred) — open a private report at
  <https://github.com/Zaidx-me/whatbot/security/advisories/new>
- **Email** — zaidxme@whatbot.app
...
whatbot already ships several hardening measures: API-key auth with roles
...
When exposing whatbot, please review the security-relevant configuration documented in
