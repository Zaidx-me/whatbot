...
export function Infrastructure() {
  ...
  useEffect(() => {
    ...
    setDbConfig(prev => ({
      ...
      // builtIn reflects whether whatbot's bundled container is actually running (live), not saved intent.
  ...
  const handleExportBackup = async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = `whatbot-backup-${dump.exportedAt?.slice(0, 10) || 'data'}.json`;
      a.click();
