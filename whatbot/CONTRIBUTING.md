# Contributing to whatbot

Thanks for your interest in improving whatbot! This guide covers how to get set up, the
...
whatbot is a NestJS (backend) + React/Vite (dashboard) project:
